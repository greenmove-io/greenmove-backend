...
CREATE TABLE places_qualities (
  ...
  greenspace INTEGER,
  greenspace_area_ratio NUMERIC(16, 2),
  waste_recycling INTEGER,
  park_area_ratio NUMERIC(16, 2),
  park_average_area NUMERIC(16, 2),
  park_population_ratio NUMERIC(16, 2),
  vehicle_population_ratio NUMERIC(16, 2),
  bus_stop_population_ratio NUMERIC(16, 2),
  bicycle_parking_population_ratio NUMERIC(16, 2),
  walking_routes_ratio NUMERIC(16, 2),
  cycling_routes_ratio NUMERIC(16, 2),
